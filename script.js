window.addEventListener('load', function(){
    ...
    class HiveWhale extends Enemy {
        constructor(game){
            ...
            this.score = this.lives;
            this.type = 'hivewhale';
            this.frameX = Math.random() * -1.2 - 0.2;
        }
    }
    ...
    class Explosion {
        ...
        draw(context){
            context.drawImage(this.image, this.frameX * this.spriteWidth, 0, this.spriteWidth, this.spriteHeight, this.x, this.y);
        }
    }
        ...
        draw(context){
            ...
            if (this.game.gameOver){
                ...
                if (this.game.score > this.game.winningScore){
                    ...
                    message1 = 'HODL this L!';
                    message2 = 'Grab the repair kit and try again!';
                }
